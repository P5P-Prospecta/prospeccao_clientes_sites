...
6. Atualize o lead (skill `supabase-sync`, `upsert-lead`): `contrato_status: "enviado"`, `contrato_em: [data de hoje]`, `manutencao: [valor mensal, se contratada]`. Quando o usuário contar que o cliente assinou, atualize `contrato_status: "assinado"`; quando contar que recebeu o pagamento, `pago: true`. Esses campos alimentam as vistas Contratos e Financeiro do painel web.
